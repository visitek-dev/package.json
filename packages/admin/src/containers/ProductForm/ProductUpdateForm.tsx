...
const AddProduct: React.FC<Props> = () => {
    ...
    // const {cate, error, refetch} = useQuery(GET_CATEGORIES);
    // const options = cate?.categories.map(item => item);
    ...
    const [tag, setTag] = useState([{value: data.categories}]);
                                            ...
                                            {data.image.map(
                                                item =>{
                                                    ...
                                                    return (
                                                        ...
                                                        <img
                                                        src={process.env.REACT_APP_ASSETS_IMG +item}
                                                        style={img} key={item} alt={item}/></div> )
                                                }
                                            )}
